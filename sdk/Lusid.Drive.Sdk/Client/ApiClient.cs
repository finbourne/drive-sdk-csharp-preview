...
namespace Lusid.Drive.Sdk.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Lusid.Drive.Sdk.Client.Configuration.Default;
            RestClient = new RestClient("https://fbn-ci.lusid.com/drive");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://fbn-ci.lusid.com/drive).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? Lusid.Drive.Sdk.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://fbn-ci.lusid.com/drive")
        {

...
namespace Lusid.Drive.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "OpenAPI-Generator/0.1.80/csharp";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "OpenAPI-Generator/0.1.80/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 0.1.80\n";
            report += "    SDK Package Version: 0.1.80\n";
